...
public class HelpDialog extends JDialog{
	...
	public HelpDialog(Frame parent, String title, boolean modal){
		...
		JTextArea helpTxt = new JTextArea();
				...
				+ "\n\n"
				+ "PRETRAGA"
				+ "\nU gornjem desnom uglu ToolBar-a nalazi se polje cijim popunjavanjem i\n klikom dugmeta sa 'lupom', koje je pozicionirano desno od njega,\n korisnik vrsi tekstualnu pretragu entiteta"
				+ " informacionog sistema.\n Kao i ranije najpre je potrebno izabrati zeljeni tab sa tabelom nad kojom se vrsi filtriranje. Ako se pretrazivanje vrsi nad Studentima moguce su\n tri vrste unosa:"
				+ " samo prezime, prezime i ime odvojeno zarezom, broj\n indeksa zarez prezime zarez ime. Unesen tekst ne mora postovati\n mala i velika slova, takodje ne moraju se uneti puni nazivi kriterijuma\n "
				+ " pretrage. Kod pretrage profesora moze da se unose ili samo ime ili\n prezime i ime odvojeno zarezom, a kod pretrage predmeta filtriranje se vrsi unosom sifre i naziva, opet odvojenih zarezom."
				+ " Brisanjem unetog sadrazaja polja pretrage i klikom na 'lupu' prikaz tabele se vraca u normalu."
				+ "\n\n"
				+ "DODAVANJE I UKLANJANJE PROFESORA SA PREDMETA"
				+ "\n Izborom taba 'Predmeti' i otvaranjem dijaloga za izmenu referentu je pored mogucnosti izmene informacija o predmetu omoguceno i dodavanje\n profesora kao i brisanje istog sa odabranog predmeta"
				+ ". Ukoliko niko ne\n predaje dati predmet, polje za unos ce biti prazno a u suprotnom bice\n ispisano ime i prezime predavaca. Klikom na dugme sa oznakom '+'\n pojavice se tabela sa profesorima"
				+ " i ukoliko korisnik oznaci jednog od\n ponudjenih entiteta i ide na 'Potvrdi' izvrsice se automatsko\n dodeljivanje profesora na izabrani predmet. Slicno je i sa brisnjem\n profesora. Ukoliko polje"
				+ " za njega nije prazno, pritiskom na dugme\n sa oznakom '-' odradice se uklanjanje prikazanog profesora sa predmeta. "
				+ "\n\n"
				+ "POSTAVLJANJE SEFA KATEDRE"
				+ "\nU tabu 'Katedre' nalazi se tabela sa informacijama o postojecim katedrama. Izborom konkretne katedre i pritiskom dugmeta 'Dodaj' koje se nalazi iznad samog tabelarnog prikaza korisniku je omoguceno"
				+ " da postavi novog\n sefa katedre, izbrom profesora iz ponudjenje liste i klikom na dugme\n za potvrdu."
				+ "\n\n"
				+ "LOKALIZACIJA"
